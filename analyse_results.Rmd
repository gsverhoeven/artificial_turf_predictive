...
Check what the benchmark is, ** exactly **, for the Lit study. They use the period 2009/2010 to 2015/2016, i.e. the average of seven seasons as out-of-sample.
...
There is some literature on "long shot bias" in bookmakers odds, where models could outperform the bookmakers.
...
# use in manuscript
saveRDS(res, "output/res_match_type.rds")
```
...
saveRDS(res_upper_lower, "output/res_upper_lower.RDS")
```
...
saveRDS(res_upper_lower_at, "output/res_upper_lower_at.RDS")
```
...
saveRDS(res_time, "output/res_time.rds")
```
